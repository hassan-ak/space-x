                                ...
                                <CardContent className="slCard">
                                    ...
                                    <div className="imageDiv">
                                        {(launch.links?.mission_patch_small)?.length && launch.links?.mission_patch_small ?
                                            <img src={launch.links?.mission_patch_small} className="cardImage" alt="upComming" />
                                            : <img src={noImage} className="cardImage" alt="upComming" />}
                                    </div>
                                    ...
                                    <Link to={`/launches/upcomming/${launch?.flight_number}`} className=" buttonLink">
                                        <Button
                                            variant="contained"
